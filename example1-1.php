...
<body>
<h1> The gas gaints </h1>

    <div class="planet jupiter">
        <h2>Jupiter</h2>

        <p class="bkg">Jupiter is the fifth planet from the Sun and the largest planet within the
